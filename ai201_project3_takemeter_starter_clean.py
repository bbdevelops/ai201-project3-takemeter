# -*- coding: utf-8 -*-
"""Brian_Brown_ai201_project3_takemeter_starter_clean.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1nhjgGgWoCgUueQt7qoYR3PE6p670kF0v
...
LABEL_MAP = {
    "advice-seeking":  0,   # ← Replace with your first label
    "experience-sharing":  1,   # ← Replace with your second label
    "venting":  2,   # ← Replace with your third label (remove if you have 2 labels)
    "showcasing": 3,  # ← Uncomment if you have a fourth label
}
...
SYSTEM_PROMPT = """
You are classifying posts and comments from from r/csMajors (Reddit) — a subreddit of ~447,000 computer science students who actively discuss internship searches, interview preparation, career anxiety, and personal projects.
Assign each post to exactly one of the following categories.

advice-seeking: The poster is asking the community for guidance on a decision, strategy, or situation — the core of the post is a question directed at others.
Example: "Cloud Software Intern, GeForce NOW - Fall 2026

Hey! Just got an interview position for this role. Anyone have ideas of what to expect? I've heard that nvidia interviews are extremely team dependent

Anything would be appreciated"

experience-sharing: The poster is reporting a personal outcome, journey, or data point — an offer, rejection, interview debrief, or career timeline — primarily to inform, not to ask.
Example: "Finally got a offer!
...
venting: The poster is expressing frustration, anxiety, or pessimism about CS careers or their personal situation WITHOUT making an actionable request for help.
Example: "i regret choosing business informatics instead of computer science
...
showcasing: The poster is presenting a project, tool, portfolio piece, or resource they created, primarily to display it and invite general feedback.
Example: "I deployed a discord activity/bot that lets you race people in solving LeetCode problems. Works in a voice channel and submissions are verified automatically (with a submit button), all the players have to do is provide their LeetCode username. The bot tracks wins (and win streaks) and provides leaderboards. Would be glad to receive feedback, thank you!

[https://github.com/timurmamedov1/LeetRace](https://github.com/timurmamedov1/LeetRace)"
